...
import org.openmrs.module.labmodule.reporting.definition.LabTreatmentStartedCohortDefinitionEvaluator;
...
public class MdrtbTreatmentStartedCohortDefinitionEvaluatorTest extends BaseModuleContextSensitiveTest {
	...
	/**
	 * @see {@link LabTreatmentStartedCohortDefinitionEvaluator#evaluate(CohortDefinition,EvaluationContext)}
	 */
	@Test
	...
	public void evaluate_shouldReturnPatientsWhoseFirstTbRegimenWasDuringThePassedPeriod() throws Exception {
		LabTreatmentStartedCohortDefinition cd = new LabTreatmentStartedCohortDefinition();
