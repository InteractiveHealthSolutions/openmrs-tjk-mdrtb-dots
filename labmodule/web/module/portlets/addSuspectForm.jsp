...
<c:if test="${model.authenticatedUser != null}">
	...
	<div id="createPatient">
		<b class="boxHeader">
					<openmrs:message code="labmodule.createNewSuspect"/>
		</b>
		<div class="box">
			<openmrs:message code="Person.search.instructions"/> <br/>
			
			<form method="get" action="${pageContext.request.contextPath}/module/labmodule/lab/addPerson.form" onSubmit="return validateForm()">
