...
public class ReportUtil {
    ...
    public static Map<String,CohortDefinition> getMdrtbPreviousTreatmentFilterSet(Date startDate, Date endDate) {
		...
		others.add(Context.getService(MdrtbService.class).getConcept(MdrtbConcepts.OTHER));
		others.add(Context.getService(MdrtbService.class).getConcept(MdrtbConcepts.UNKNOWN));
		//others.add();
		
		
		CohortDefinition otherStar =  Cohorts.getMdrtbPatientProgramStateFilter(workflowConcept, others, startDate, endDate);
		CohortDefinition unknown =  Cohorts.getMdrtbPatientProgramStateFilter(workflowConcept, new ArrayList(), startDate, endDate);
...
*/		
	...
	public static Map<Integer,List<MdrtbPatientProgram>> getMdrtbPatientProgramsEnrolledInDateRangeMap(Date startDate, Date endDate) {
		
		Map<Integer,List<MdrtbPatientProgram>> tbPatientProgramsMap = new HashMap<Integer,List<MdrtbPatientProgram>>();
		
		// get all the mdrtb patient programs
		for (MdrtbPatientProgram program : Context.getService(MdrtbService.class).getAllMdrtbPatientProgramsEnrolledInDateRange(startDate, endDate)) {
			Integer patientId = program.getPatient().getId();
