			...
			<tbody>
				<c:forEach var="patient" items="${model.data}">
					...
					<tr>
						...
						<td colspan="4"><span class="mdrListLabel">Traitement Personalis�:</span><br/><span class="mdrListValue">${patient.individualizedRegimen}</span></td>
					...
					<tr bgcolor="#f0f0f0">
						<td colspan="2"><span class="mdrListLabel">Date R�ception</span><br/><span class="mdrListValue">${patient.startDate}</span></td>
